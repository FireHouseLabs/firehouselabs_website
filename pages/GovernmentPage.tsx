...
const GovernmentPage: React.FC = () => {
  ...
  const offerings = [
    "Custom platforms for incident, asset, or resource tracking",
    "Internal portals for compliance, SOPs, or team coordination",
    "Digital transformation for legacy or paper-based systems",
    "Integrations with existing tools or CRMs"
  ];

  const whyUs = [
    "Experience with government procurement cycles",
    "Focus on operational reliability & hierarchy",
    "Built-in permissions, auditing, and offline-first workflows",
    "Based in Australia and ready to support your rollout"
  ];

  // Get the emergency services projects
  const caseStudyProjects = PROJECTS.filter(p => p.id === 'stationone' || p.id === 'aar-link');

  return (
    <div className="pt-20">
      <SEO
        title="Government & Emergency Services"
        description="Custom software for brigades, councils, and public agencies. We build operational tools tailored to emergency services and government workflows."
      />
      {/* Hero */}
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="max-w-5xl mb-24">
            <div className="animate-fade-in-up">
              <span className="text-brand font-bold tracking-widest text-sm uppercase mb-6 block">Government & Emergency Services</span>
              <h1 className="text-5xl md:text-7xl font-black leading-[1.1] tracking-tighter mb-8">
                Custom Software for <br />
                <span className="gradient-text">Emergency Services</span> and <br />
                Government Teams
              </h1>
              <p className="text-neutral-400 text-xl leading-relaxed max-w-3xl">
                We build operational tools for brigades, councils, and public agencies that need software to match the way they work.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6">
          <div className="max-w-4xl">
            ...
            <p className="text-neutral-400 text-lg leading-relaxed">
              From local brigades to regional coordination, we understand the challenges of managing assets, crews, and compliance under pressure. We design tools that are secure, scalable, and built to support your operational reality.
            </p>
          </div>
        </div>
      </section>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="glass p-10 md:p-16 rounded-[3rem] border border-brand/20 text-center bg-gradient-to-br from-brand/5 to-transparent">
              ...
              <p className="text-neutral-400 text-lg mb-10 max-w-2xl mx-auto">
                Let's discuss how we can build software that matches your operational reality.
              </p>
